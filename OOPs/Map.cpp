...
int main()
{
	...
	populationMap.insert(make_pair("Delhi", 19));
	populationMap.insert(make_pair("Jammu_and_Kashmir", 14));
	...
	populationMap.insert(make_pair("Puducherry", 2));
	populationMap.insert(make_pair("Mizoram", 1));
	populationMap.insert(make_pair("Chandigarh", 1));
	populationMap.insert(make_pair("Sikkim", 1));
	populationMap.insert(make_pair("Dadra_and_Nagar_Haveli_and_Daman_and_Diu", 1));
	populationMap.insert(make_pair("Andaman_Nicobar", 1));
	populationMap.insert(make_pair("Lakshadweep", 0.0003));
	populationMap.insert(make_pair("Ladakh", 0.00006));
